...
if DEBUG:
    ...
    if train:
        ...
        trainDFOutPath = "s3://jiayun.spark.data/wangqi/I2IRankData/TrainData/{}".format(_args.date)
        evalDFOutPath = "s3://jiayun.spark.data/wangqi/I2IRankData/EvalData/{}".format(_args.date)
    else:
        ...
        # labelPath = 's3://jiayun.spark.data/wangqi//I2IRankData/TextFile/LabelData/'
        predDFOutPath = 's3://jiayun.spark.data/wangqi/I2IRankData/PredData/{}'.format(_args.date)
...
if train:
    ...
    DF2_sample = DF2_sample.withColumn('featrues1_features2', u_mergeTwoItemProfile(DF2_sample.features1, DF2_sample.features2))
    DF3_sample = DF2_sample.withColumn('merge', concat_ws(primary_delim, DF2_sample['label'], DF2_sample['featrues1_features2']))
    ...
    DF3 = DF2.withColumn('merge', concat_ws(primary_delim, DF2['label'], DF2['featrues1_features2']))
    ...
    DF2 = union_label_feature(LabelDF, itemProfileDF)
    DF2 = DF2.withColumn('featrues1_features2', u_mergeTwoItemProfile(DF2.features1, DF2.features2))
